...
import type { CSSPropertyGridArea, CSSPropetyGridAutoFlow, CSSPropertyGridColumn, CSSPropertyGridRow, Responsive } from 'types/styles'
...
type GridProps = BoxProps & {
    ...
    gridAutoFlow?: Responsive<CSSPropetyGridAutoFlow>
